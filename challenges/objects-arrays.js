...
const lowerCase =
  zooAnimals.map((lowName) => `${lowName.animal_name}`.toLowerCase());
...
*/
const lowerPopulation = zooAnimals.filter((lowerPopulation) => {
...
*/
const populationTotal = zooAnimals.reduce((acc, totalPop) => {
